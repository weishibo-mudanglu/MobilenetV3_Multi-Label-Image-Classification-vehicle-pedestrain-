...
class MobileNetV3(nn.Module):
    def __init__(self, num_classes=1000,type='large'):
        ...
        self.linear1 = nn.Linear(96,10,bias=False)
        self.linear2 = nn.Linear(96,10,bias=False)
        self.linear3 = nn.Linear(96,10,bias=False)
        self.linear4 = nn.Linear(96,10,bias=False)
        self.linear5 = nn.Linear(96,10,bias=False)
        self.linear6 = nn.Linear(96,10,bias=False)
        self.linear7 = nn.Linear(96,10,bias=False)
        self.linear8 = nn.Linear(96,10,bias=False)
        self.linear9 = nn.Linear(96,10,bias=False)
        self.linear10 = nn.Linear(96,10,bias=False)
        self.reclassify_one1 = nn.Linear(10,2,bias=False)
        self.reclassify_one2 = nn.Linear(10,2,bias=False)
        self.reclassify_one3 = nn.Linear(10,2,bias=False)
        self.reclassify_one4 = nn.Linear(10,2,bias=False)
        self.reclassify_one5 = nn.Linear(10,2,bias=False)
        self.reclassify_one6 = nn.Linear(10,2,bias=False)

        self.reclassify_two9 = nn.Linear(10,2,bias=False)
        self.reclassify_three7 = nn.Linear(10,3,bias=False)
        self.reclassify_three8 = nn.Linear(10,3,bias=False)
        self.reclassify_three10 = nn.Linear(10,3,bias=False)
